...
export class WasmSpilmanBridge {
     ...
     * @returns {string}
     */
    processPayment(payment_json, context_json, keyset_info_json) {
        let deferred5_0;
        let deferred5_1;
        try {
            ...
            var ptr2 = isLikeNone(keyset_info_json) ? 0 : passStringToWasm0(keyset_info_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len2 = WASM_VECTOR_LEN;
            const ret = wasm.wasmspilmanbridge_processPayment(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
     ...
     */
    constructor(js_host, server_secret_key_hex) {
        var ptr0 = isLikeNone(server_secret_key_hex) ? 0 : passStringToWasm0(server_secret_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmspilmanbridge_new(js_host, ptr0, len0);
        if (ret[2]) {
 ...
 * @returns {string}
 */
export function channel_parameters_get_channel_id(params_json, shared_secret_hex, keyset_info_json) {
    let deferred5_0;
    let deferred5_1;
    try {
 ...
 * @returns {string}
 */
export function compute_shared_secret(my_secret_hex, their_pubkey_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function construct_proofs(blind_signatures_json, secrets_with_blinding_json, keyset_info_json) {
    let deferred5_0;
    let deferred5_1;
    try {
 ...
 * @returns {string}
 */
export function get_receiver_blinded_secret_key_for_stage2_output(params_json, keyset_info_json, charlie_secret_hex, shared_secret_hex, amount, index) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function get_sender_blinded_secret_key_for_stage2_output(params_json, keyset_info_json, alice_secret_hex, amount, index) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function unblind_and_verify_dleq(blind_signatures_json, secrets_with_blinding_json, params_json, keyset_info_json, shared_secret_hex, balance, output_keyset_info_json) {
    let deferred8_0;
    let deferred8_1;
    try {
        const ptr0 = passStringToWasm0(blind_signatures_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {boolean}
 */
export function verify_balance_update_signature(params_json, shared_secret_hex, funding_proofs_json, keyset_info_json, channel_id, balance, signature) {
    const ptr0 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(shared_secret_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
export function verify_channel(params_json, shared_secret_hex, funding_proofs_json, keyset_info_json) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getActiveKeysetIds_89c0f59500efd972 = function(arg0, arg1, arg2, arg3, arg4) {
        const ret = arg0.getActiveKeysetIds(getStringFromWasm0(arg1, arg2), getStringFromWasm0(arg3, arg4));
        return ret;
    };
    imports.wbg.__wbg_getAmountDue_4bcba6169881e28a = function(arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_getKeysetInfo_7359549655659127 = function(arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_getServerConfig_7dbf94cf2b14ae90 = function(arg0, arg1) {
        const ret = arg1.getServerConfig();
    ...
    imports.wbg.__wbg_isClosed_1208e9dea6432502 = function(arg0, arg1, arg2) {
        const ret = arg0.isClosed(getStringFromWasm0(arg1, arg2));
        return ret;
    };
    ...
    imports.wbg.__wbg_mintAndKeysetIsAcceptable_d66a32ec12bacfec = function(arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_nowSeconds_19e7721efab986c3 = function(arg0) {
    ...
    imports.wbg.__wbg_receiverKeyIsAcceptable_efc9b113ec9ca0f3 = function(arg0, arg1, arg2) {
    ...
    imports.wbg.__wbg_saveFunding_61fa842f69935c52 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
        arg0.saveFunding(getStringFromWasm0(arg1, arg2), getStringFromWasm0(arg3, arg4), getStringFromWasm0(arg5, arg6), getStringFromWasm0(arg7, arg8), getStringFromWasm0(arg9, arg10));
    };
